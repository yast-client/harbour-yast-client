...
PagedView {
    ...
    property real baseYOffset: currentItem && currentItem._yOffset || 0
    property real yOffset: baseYOffset - extraTopMargin
    ...
    Item {
        ...
        property real _ctxTopMargin: (_tabBarIsTop ? tabBarHeight : 0) + extraTopMargin
        property real _ctxBottomMargin: (_tabBarIsTop ? 0 : tabBarHeight) + extraBottomMargin
    }
