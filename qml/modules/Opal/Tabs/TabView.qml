...
tabFadeAnimator.target=null
item.focus=true
item.opacity=0
tabFadeAnimator.target=item
tabFadeAnimator.from=0
tabFadeAnimator.to=1
tabFadeAnimator.restart()
}FadeAnimator{id:tabFadeAnimator
running:false
