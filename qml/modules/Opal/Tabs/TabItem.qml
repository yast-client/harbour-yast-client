...
SilicaControl {
    ...
    property alias bodyItem: bodyItem

    property var tabView: _tabContainer ? _tabContainer.PagedView.view : null

    property real topMargin: parent._ctxTopMargin || _ctxTopMargin || 0
    property real bottomMargin: parent._ctxBottomMargin || _ctxBottomMargin || 0
    ...
    readonly property real _yOffset: _hasPullDownMenu
    ...
    implicitHeight: {
        ...
        } else if (_hasPullDownMenu && tabView) {
